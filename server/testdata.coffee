...
Meteor.startup ->
    if BlogPosts.find().count() is 0
        ...
        ,
          ...
          titleImageLink: ""
        ,
          content: "<p>3rd post content html</p>"
          title: "Title of the third test blog post "
          day: "Thirdsday"
          datetime: "2013-12-31"
          summary: "summary text for the third blog post"
          time: "01:00"
          slug: "title-of-the-third-test-blog-post"
          titleImageLink: ""
        ]
